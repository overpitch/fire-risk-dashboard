...
from config import (
    ...
    SOIL_MOISTURE_STATION_ID, WEATHER_STATION_ID, WUNDERGROUND_STATION_ID,
    logger
)
...
def get_wunderground_data(station_id: str = WUNDERGROUND_STATION_ID) -> Optional[Dict[str, Any]]:
